...
for label in CE.clusters:
    ...
    plt.tight_layout()
    plt.savefig('../../Dropbox/papers/clustering/img/USweekday_clusters.eps', format='eps', dpi=1000)
...
with open(stem+'USMEAlabels.csv','w') as csvfile:
    writer = csv.writer(csvfile)
    for vehicle in labels:
        writer.writerow([vehicle,labels[vehicle]])
...
for label in CE.clusters:
    ...
    #plt.legend(loc=locs[label],frameon=False)
    plt.tight_layout()
    plt.savefig('../../Dropbox/papers/clustering/img/USweekend_clusters.eps', format='eps', dpi=1000)
...
with open(stem+'USMEAlabelsWE.csv','w') as csvfile:
    writer = csv.writer(csvfile)
    for vehicle in labels:
        writer.writerow([vehicle,labels[vehicle]])
