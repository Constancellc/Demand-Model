...
for i in range(3):
    ...
    axs[i].set_title(str(i+1),color='k',y=0.55)
#plt.tight_layout()
...
#plt.tight_layout()
plt.savefig('../../Dropbox/thesis/chapter4/img/weekdayHM.eps', format='eps',
...
cbar.ax.set_yticklabels(['0%','20%','40%','60%','80%','100%'])
#plt.tight_layout()
plt.savefig('../../Dropbox/thesis/chapter4/img/weekendHM.eps', format='eps',
            dpi=300, bbox_inches='tight', pad_inches=0)
...
axs3[0].set_title('Weekday',color='k',y=0.55)
...
axs3[1].set_title('Weekend',color='k',y=0.55)
...
#plt.tight_layout()
plt.savefig('../../Dropbox/thesis/chapter4/img/randomHM.eps', format='eps',
            dpi=300, bbox_inches='tight', pad_inches=0)
