...
for m in months:
    ...
    with open(resultsStem+m+'-solar.csv','rU') as csvfile:
        ...
        for row in reader:
            ...
            p5.append(float(row[10]))
            p6.append(float(row[11]))
            p7.append(float(row[12]))
            p8.append(float(row[13]))
            p9.append(float(row[14]))
            p10.append(float(row[15]))
            p11.append(float(row[16]))
            p12.append(float(row[17]))
            p13.append(float(row[18]))
            p14.append(float(row[19]))
            p15.append(float(row[20]))
    ...
    plt.fill_between(t,p1,p15,color='#b7d2ff')
    #plt.fill_between(t,p5,p4,color='#b7d2ff')
    plt.fill_between(t,p4,p12,color='#7fadff')
