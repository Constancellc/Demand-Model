...
plt.fill_between(x_fill,ibase_fill,color='#CCCCFF')
plt.title('3',y=0.8)
plt.ylim(0,40)
plt.xlim(0,36)
plt.ylabel('Power (GW)')
...
plt.ylabel('Power (kW)')
plt.tight_layout()
plt.savefig('../../Dropbox/thesis/chapter4/img/psuedo-diagram.eps', format='eps',
